...
import org.darkquest.client.model.Sector;
...
public class EngineHandle {
  ...
  public void method401(int i, int j, int k) {
    garbageCollect();
    int l = (i + 24) / 48;
    int i1 = (j + 24) / 48;
  ...
  private String process(String s) {
    ...
    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(
      "HH:mm:ss");
    return s.replaceAll("&time&", sdf.format(cal.getTime()));
  }
  ...
  public void method409(int i, int j, int k, boolean flag) {
        ...
        for (int i6 = 1; i6 < 95; i6++) {
          if (getGroundTexturesOverlay(k4, i6) > 0
            ...
            int i15 = model.method179((k4 + 1) * 128,
                                      ...
                                      (i6 + 1) * 128);
            int j17 = model
                      .method179(k4 * 128, -getGroundElevation(k4,
                                 i6 + 1), (i6 + 1) * 128);
            ...
            if (getGroundTexturesOverlay(k4, i6 + 1) > 0
              ...
              int k10 = model.method179(k4 * 128,
                                        -getGroundElevation(k4, i6), i6 * 128);
              int i13 = model.method179((k4 + 1) * 128,
                                        -getGroundElevation(k4 + 1, i6), i6 * 128);
            ...
            if (getGroundTexturesOverlay(k4, i6 - 1) > 0
              ...
              int l10 = model.method179(k4 * 128,
                                        -getGroundElevation(k4, i6), i6 * 128);
              int j13 = model.method179((k4 + 1) * 128,
                                        -getGroundElevation(k4 + 1, i6), i6 * 128);
            ...
            if (getGroundTexturesOverlay(k4 + 1, i6) > 0
              ...
              int i11 = model.method179(k4 * 128,
                                        -getGroundElevation(k4, i6), i6 * 128);
              int k13 = model.method179((k4 + 1) * 128,
                                        -getGroundElevation(k4 + 1, i6), i6 * 128);
            ...
            if (getGroundTexturesOverlay(k4 - 1, i6) > 0
              ...
              int j11 = model.method179(k4 * 128,
                                        -getGroundElevation(k4, i6), i6 * 128);
              int l13 = model.method179((k4 + 1) * 128,
                                        -getGroundElevation(k4 + 1, i6), i6 * 128);
    ...
    aModelArrayArray580[k] = aModel.method182(0, 0, 1536, 1536, 8, 64, 338,
                             true);
    ...
    for (int i7 = 1; i7 < 95; i7++) {
      for (int k9 = 1; k9 < 95; k9++) {
        ...
        if (i12 > 0) {
          ...
          int j28 = EntityHandler.getElevationDef(i12 - 1)
                    .getUnknown1();
    ...
    aModelArrayArray598[k] = aModel.method182(0, 0, 1536, 1536, 8, 64, 169,
                             true);
  ...
  public void method428(Model[] models) {
    for (int i = 0; i < 94; i++) {
      for (int j = 0; j < 94; j++) {
        if (getDiagonalWalls(i, j) > 48000
            && getDiagonalWalls(i, j) < 60000) {
          ...
          method412(i, j, k, l);
          Model model = models[EntityHandler.getObjectDef(k).modelID]
                        .method204(false, true, false, false);
          int k1 = ((i + i + i1) * 128) / 2;
          int i2 = ((j + j + j1) * 128) / 2;
          ...
          if (i1 > 1 || j1 > 1) {
            for (int k2 = i; k2 < i + i1; k2++) {
              for (int l2 = j; l2 < j + j1; l2++) {
                if ((k2 > i || l2 > j)
                    && getDiagonalWalls(k2, l2) - 48001 == k) {
                  int l1 = k2;
                  int j2 = l2;
                  byte byte0 = 0;
                  if (l1 >= 48 && j2 < 48) {
